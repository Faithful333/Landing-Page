const PILLARS = [
  {
    ...
    body: 'We go early — before the pitch deck, before the first hire, often before the idea is fully formed. We enter universities and peer communities to find founders who have the conviction but not yet the clarity, and we give them the mentorship, the people, and the structure to start building something real.',
  ...
  },
  {
    ...
    body: "We don't separate business excellence from strategically shaping culture — we expect both. The founders we equip are building ventures that win commercially and bear fruit spiritually. Strategic impact isn't optional; it means building the best version of what God called you to create.",
    image: '/faithful.jpg',
